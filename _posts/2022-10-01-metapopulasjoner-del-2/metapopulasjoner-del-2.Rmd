...
```
```{r AndelVekst, cache = T, fig.cap="Gjennomsnittlig vekst i andel bebodde habitat med økende metapopulasjonskapasitet. Linjen viser en lineær regresjon. "}
...
```{r AndelBebodde, cache = T, fig.cap="Gjennomsnittlig andel bebodde habitat med økende metapopulasjonskapasitet. Linjen viser en logistisk regresjon."}
ggplot(data = ParameterSpace,
       mapping = aes(x = (EigenvalueCentrality), 
                     y = SnittPrevalens))+
  geom_point()+
...
if(!file.exists("G:/egodrive.github.io/_posts/2022-10-01-metapopulasjoner-del-2/gbif_data.csv")){
...
fwrite(Joint,"G:/egodrive.github.io/_posts/2022-10-01-metapopulasjoner-del-2/gbif_data.csv")
}
Joint = fread("G:/egodrive.github.io/_posts/2022-10-01-metapopulasjoner-del-2/gbif_data.csv")
...
```
```{r Dragehode, cache = T, fig.cap="Utbredelsen av bestandene med dragehode, hvor størrelsen reflekterer EV, verdien bestanden har for metapopulasjonen."}
sol <- metacapa(d, Ar,
                alpha = iD)
plot(sol)
