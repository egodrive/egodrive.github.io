...
```{r FIG2, fig.height = 8, fig.width = 15, fig.align = "center", echo = F, fig.cap="En art finnes ikke overalt, bare hvor den kan overleve og reprodusere."}
...
```{r FIG3, fig.height = 8, fig.width = 15, fig.align = "center", echo = F, fig.cap="Fordel (blå), ulempe (rød) og nytte (grønn) knyttet til bruken av et miljø."}
library(boot)
library(boot)
