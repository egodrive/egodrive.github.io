...
```{r FIG2, fig.height = 7, fig.width = 7, fig.align = "center", echo = F, fig.cap="En art finnes ikke overalt, bare hvor den kan overleve og reprodusere."}
