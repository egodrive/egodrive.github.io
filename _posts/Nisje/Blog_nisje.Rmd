...
(I \@ref(fig:FIG1) og \@ref(fig:FIG2) viser vi ekte data for lilje-artene *Iris setosa*, *Iris virginica* og *Iris versicolor*. Miljøvariablene er riktignok lengden og bredden av begerbladet, og bredden av kronebladet til disse artene. )
...
For at en art skal overleve må det være nok reproduksjon og overlevelse til at en på lang sikt minimum går i null. Dette kan igjen knyttes til miljøet. Hvis en følger eksempelet over for art 1. La oss si at jo mer du øker miljøvariabel 1 dess flere avkom får du, men det reduserer hvor lenge du vil leve. På en årlig basis så kan en si at en øker sannsynligheten for å få et avkom, men en reduserer sannsynligheten for at du overlever til neste år. Over tid vil disse to faktorene - overlevelse og reproduksjon - bestemmer hvor mange avkom ett individ vil få iløpet av livet (*lifetime reproductive success*). Den optimale strategien (*nytte* hvis man bruker ressursøkonomiske begreper) kan vi da finne ved å se på ved å multiplisere disse to funksjonene med hverandre (figur \@ref(fig:FIG3)). Dette kommer også frem av [denne studien](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/1365-2656.13221) (*snikskryt*). I \@ref(fig:FIG1) og \@ref(fig:FIG2) så er ikke alle punktene innenfor den fargede "konvolutten". Dette kan tolkes som at selv om individ befinner seg i et område så kan det være at det området ikke er "bra nok" slik at overlvelse og reproduksjon er for lav til at man klarer seg der på lang sikt. 

```{r FIG3, fig.height = 5, fig.width = 11, fig.align = "center", echo = F, fig.cap="Fordel (blå), ulempe (rød) og nytte (grønn) knyttet til bruken av ulike miljøvariabler. Nisjen vil da være det området hvor nytten er større enn null."}
library(boot)
